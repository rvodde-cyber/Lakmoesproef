...
export const INSTRUMENT_VERSION = "v1.2";
...
export const PAGE_CAPTIONS = [
  ...
  "Moreel vakmanschap, grenzen en datagedreven verbeteren",
...
export const questions: Question[] = [
  { id: 1, title: "Ethische visie", subtitle: "Richting en betekenis", explanation: "Is de missie van uw organisatie voor u duidelijk en bekend? Vervolgens: in welke mate is die missie concreet verbonden aan maatschappelijke waarde en verantwoord handelen?" },
  ...
  { id: 4, title: "Waarden in besluitvorming", subtitle: "Meer dan KPI's", explanation: "In welke mate worden waarden zichtbaar meegewogen naast kosten, snelheid en resultaat? (Met KPI's worden kerngetallen of prestatie-indicatoren bedoeld: meetbare stuurcijfers zoals volumes, doorlooptijden of financiële resultaten.)" },
  ...
  { id: 10, title: "Eigenaarschap", subtitle: "Verantwoordelijkheid op elk niveau", explanation: "In welke mate ervaren professionals dat zij zelf verantwoordelijkheid dragen voor de ethische kwaliteit van hun werkzaamheden?" },
  ...
  { id: 13, title: "Samenwerking", subtitle: "Muren tussen afdelingen doorbreken", explanation: "In welke mate werken teams en afdelingen integraal samen aan gedeelde waarden en doelen?" },
  ...
  { id: 15, title: "Morele reflectie", subtitle: "Tijd voor beraad", explanation: "In welke mate bestaat er structureel ruimte voor ethische reflectie op complexe casuïstiek?" },
  { id: 16, title: "Moreel vakmanschap", subtitle: "Morele kennis en competenties", explanation: "In welke mate worden medewerkers getraind in morele oordeelsvorming en professioneel handelen?" },
